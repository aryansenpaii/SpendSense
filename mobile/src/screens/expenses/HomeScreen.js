...
const styles = StyleSheet.create({
  ...
  summaryGreet: { color: '#8892b0', fontSize: 16, fontWeight: '600' },
  summaryLabel: { color: '#8892b0', fontSize: 14, marginTop: 14, textTransform: 'uppercase', letterSpacing: 1 },
  summaryAmount: { color: '#e94560', fontSize: 44, fontWeight: '900', marginTop: 4 },
